...
for Android in form of an `.apk` file. [You can get all the required files directly from your phone](https://stackoverflow.com/questions/11012976/how-do-i-get-the-apk-of-an-installed-app-without-root-access) or by using any APK extractor you can find on Google Play. **Note:** After August 2022 update, the game is no longer supplied in plain APK, but in a XAPK instead. [Follow this guide](https://samilops2.gitbook.io/vita-troubleshooting-guide/shader-compiler/extract-libshacccg.suprx) to obtain a normal ARMv7 APK for the updated version.
